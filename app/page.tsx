...
function ProfilePhoto({ className }: { className?: string }) {
    return (
        ...
        >
            ...
            <div className="absolute -bottom-1 -right-1 w-20 h-20 bg-primary rounded-full border-4 border-white flex items-center justify-center shadow-lg overflow-hidden p-2">
